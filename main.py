...
from presentation.telegram import start_telegram
...
async def create_bot() -> MusicBot:
    ...
    try:
        ...
        # Start Telegram service in background if enabled
        try:
            await start_telegram(container, settings)
        except Exception as e:
            logging.error(f"Failed to start Telegram service: {e}")
